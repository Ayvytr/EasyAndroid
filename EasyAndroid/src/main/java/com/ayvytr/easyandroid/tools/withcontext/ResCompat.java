...
/**
 * 这个类是专门用于自定义控件时，需要使用控件的 {@link Context} 时，专门提供的类，用来做控件的初始化操作，使用
...
public class ResCompat extends ResTool
{
    /**
     * 从资源中获取Drawable
     *
    ...
    {
        return DensityTool.px2dp(context, getDimenFloat(context, id));
    }
