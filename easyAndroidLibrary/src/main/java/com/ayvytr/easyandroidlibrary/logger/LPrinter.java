...
final class LPrinter implements Printer
{
     ...
     */
    @Override
    public LSettings init(String tag)
    {
        if(tag == null)
        {
    ...
    private int getStackOffset(StackTraceElement[] trace)
    {
        for(int i = MIN_STACK_OFFSET; i < trace.length; i++)
        {
            ...
            if(!name.equals(LPrinter.class.getName()) && !name.equals(L.class.getName()))
            {
                return --i;
            }
        }
